...
import { listWebhooks, webhookReady } from '../src/billing-config.mjs';
...
if (!endpoints.some(e => webhookReady(e, c))) throw new Error('Webhook live ausente, desativado ou sem todos os eventos obrigatórios.');
